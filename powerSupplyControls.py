...
def multipleChannelsPsuTest():
    ...
    time.sleep(2)
    print("PSU Test Done")
    powerSupply.write(':OUTP CH2, OFF') # tell the psu to turn OFF channel_1.
    ...
    time.sleep(2)
    print("PSU Test Done")
    powerSupply.write(':OUTP CH3, OFF') # tell the psu to turn OFF channel_1.
